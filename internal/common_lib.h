...
typedef vector<BasePoint, Eigen::aligned_allocator<BasePoint>> PointVector;
...
struct Pose6D {
    Pose6D() :offset_time(0.0), acc{ 0, 0, 0 }, gyr{ 0, 0, 0 }, vel{ 0, 0, 0 }, pos{ 0, 0, 0 }, rot{0, 0, 0, 0, 0, 0, 0 ,0 ,0}
    {
    }
    double offset_time;
    double acc[3];
